...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-upgrade-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14098&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-upgrade-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-upgrade` can be installed with:

```
conda install django-upgrade
```

It is possible to list all of the versions of `django-upgrade` available on your platform with:
